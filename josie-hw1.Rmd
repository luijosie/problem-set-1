...
map_cluster %>% filter(state=="Wisconsin")%>% select(group)
g1 <- ggplot()+
  geom_sf(data = map_cluster,
          aes(geometry=geometry,
              fill = as.factor(group)),
